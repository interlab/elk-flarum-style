...
function flarumstyleShowTopics(array $topics)
{
    ...
    foreach ($topics as $topic) {
        ...
        $topic['subject'] = $topic['use_sticky'] ? '<span class="flarum-sticky-icon"></span> '. $lockicon .
            '<strong>'. $topic['icon'] .' '. $newicon .'<a href="'. $topic['href'] .'" class="flarum-topic-a">'.
            $topic['subject'] .'</a></strong>' : $lockicon . $topic['icon'] .' '. $newicon .
            '<a href="'. $topic['href'] .'" class="flarum-topic-a">'. $topic['subject'] .'</a>';
    ...
    $topic['board']['link'], '</span></li>
        ...
        echo '
            ...
            <div class="flarum-footer-topic">
                <strong><i class="fa fa-user" aria-hidden="true"></i> ', $topic['poster']['link'], '</strong> ',
                $topic['posted'], ' ', $topic['time'], '
